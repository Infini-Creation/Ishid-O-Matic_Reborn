...
var highlight_text_mode : Dictionary = {
	Global.HIGHLIGHT_MODE.HIGHLIGHT_NONE: "None",
	Global.HIGHLIGHT_MODE.FIRST_AVAIL_MOVE: "First",
	Global.HIGHLIGHT_MODE.ALL_AVAIL_MOVE: "All",
	Global.HIGHLIGHT_MODE.RANDOM_MOVE: "Random",
	Global.HIGHLIGHT_MODE.HIGHER_SCORE_MOVE: "BestScore"
	}
